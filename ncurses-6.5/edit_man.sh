...
TERMINFO="/home/zubayer/django-react-rabbitMQ/ncurses-6.5/build/share/terminfo"
TERMINFO_DIRS="/home/zubayer/django-react-rabbitMQ/ncurses-6.5/build/share/terminfo"
...
(*.[0-9]*)
	...
	if test ! -f "/home/zubayer/django-react-rabbitMQ/ncurses-6.5/man_alias.sed" ; then
cat >>/home/zubayer/django-react-rabbitMQ/ncurses-6.5/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /home/zubayer/django-react-rabbitMQ/ncurses-6.5/man_alias.sed"
	fi
	...
	aliases=`sed -f "$top_srcdir/man/manlinks.sed" "$cf_full_alias" |sed -f "/home/zubayer/django-react-rabbitMQ/ncurses-6.5/man_alias.sed" | sort -u; test "$cf_part_alias" = "$nCurses" && echo curses`
	cf_target=`grep "^$cf_source" /home/zubayer/django-react-rabbitMQ/ncurses-6.5/man/man_db.renames | mawk '{print $2}'`
	...
	sed	-f "/home/zubayer/django-react-rabbitMQ/ncurses-6.5/man_alias.sed" \
		< "$i" | sed -f /home/zubayer/django-react-rabbitMQ/ncurses-6.5/edit_man.sed >$TMP
