...
class BeamGlobalAssembler : public BeamAssembler {
    ...
    void emit_bs_init_bits_shared(void);
    void emit_bs_init_bits_legacy_shared(void);
...
public:
    ...
    void (*get_bs_init_bits_shared(void))() { return get(bs_init_bits_shared); }
    void (*get_bs_init_bits_legacy_shared(void))() { return get(bs_init_bits_legacy_shared); }
...
BeamGlobalAssembler::emitPtrs = {
    ...
    {bs_init_bits_shared, &BeamGlobalAssembler::emit_bs_init_bits_shared},
    {bs_init_bits_legacy_shared, &BeamGlobalAssembler::emit_bs_init_bits_legacy_shared},
...
BeamGlobalAssembler::labelNames = {
    ...
    {bs_init_bits_shared, "bs_init_bits_shared"},
    {bs_init_bits_legacy_shared, "bs_init_bits_legacy_shared"},
